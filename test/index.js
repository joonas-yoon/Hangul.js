...
QUnit.test('Hangul.assemble Tests', function (assert) {
    ...
    assert.deepEqual(
        Hangul.assemble(['ㅃ','ㅞ','ㄹ','ㄱ','ㅅ']),
        '쀍ㅅ',
        "Hangul.assemble(['ㅃ','ㅞ','ㄹ','ㄱ','ㅅ'])"
    );
    assert.deepEqual(
        Hangul.assemble(['ㅃ','ㅞ','ㄹ','ㄱ','ㅏ']),
        '쀌가',
        "Hangul.assemble(['ㅃ','ㅞ','ㄹ','ㄱ','ㅏ'])"
    );
    assert.deepEqual(
        Hangul.assemble(['ㅃ','ㅞ','ㄹ','ㄱ','ㅞ','ㄹ','ㄱ','ㅞ','ㄹ','ㄱ','ㅂ']),
        '쀌궬궭ㅂ',
        "Hangul.assemble(['ㅃ','ㅞ','ㄹ','ㄱ','ㅞ','ㄹ','ㄱ','ㅞ','ㄹ','ㄱ','ㅂ'])"
    );
});
...
QUnit.test('Hangul.shift for allCharacters Tests', function (assert) {
    assert.deepEqual(
        Hangul.shift('제발도와주세요 쉬프트가 들어가서 안빠져요 제발도와주세요 어캐해야하죠 쉬프트때문에 미치겠어요 이런걸로 에이에스 맡길수도 없고 그렇다고 내공걸수도 없고 제발 도와주세요'),
        '쪠빨또와쭈쎼요 쒸프트까 뜰어까써 안빠쪄요 쪠빨또와쭈쎼요 어컈햬야하쬬 쒸프트떄문예 미치꼤어요 이런껄로 예이예쓰 맡낄쑤또 어ㅃㅆ꼬 끄렇따꼬 냬꽁껄쑤또 어ㅃㅆ꼬 쪠빨 또와쭈쎼요',
        "Hangul.shift('제발도와주세요 쉬프트가 들어가서 안빠져요 제발도와주세요 어캐해야하죠 쉬프트때문에 미치겠어요 이런걸로 에이에스 맡길수도 없고 그렇다고 내공걸수도 없고 제발 도와주세요')"
    );
    
    assert.deepEqual(
        Hangul.shift('나랏말씀이 중국과 달라 한문한자와 서로 통하지 아니하므로 이런 까닭으로 어리석은 백성들이 말하고자 하는 바가 있어도 끝내 제 뜻을 펴지 못하는 사람이 많다'),
        '나랐말씀이 쭝꾺꽈 딸라 한문한짜와 써로 통하찌 아니하므로 이런 까딸ㄲ으로 어리썪은 뺶썽뜰이 말하꼬짜 하는 빠까 있어또 끝냬 쪠 뜼을 펴찌 몼하는 싸람이 많따',
        "Hangul.shift('나랏말씀이 중국과 달라 한문한자와 서로 통하지 아니하므로 이런 까닭으로 어리석은 백성들이 말하고자 하는 바가 있어도 끝내 제 뜻을 펴지 못하는 사람이 많다')"
    );
    
    assert.deepEqual(
        Hangul.shift('괆/퀡/퇣/풿/횂/뚫/훑/송/땄/쮰/뿕/읁'),
        '꽒/쿠ㅖㄹㄲ/토ㅒㄹㅃ/푸ㅖㅀ/호ㅒㅃㅆ/뚫/훑/쏭/땄/쮰/뿔ㄲ/은ㅉ',
        "Hangul.shift('괆/퀡/퇣/풿/횂/뚫/훑/송/땄/쮰/뿕/읁') == '꽒/쿠ㅖㄹㄲ/토ㅒㄹㅃ/푸ㅖㅀ/호ㅒㅃㅆ/뚫/훑/쏭/땄/쮰/뿔ㄲ/은ㅉ'"
    );
    
    assert.deepEqual(
        Hangul.shift('ㄱㄴㄷㄹㅁㅂㅅㅇㅈㅊㅋㅌㅍㅎ ㅏㅐㅓㅔㅗㅚㅜㅟㅢ'),
        'ㄲㄴㄸㄻㅃㅆㅇㅉㅊㅋㅌㅍㅎ ㅏㅒㅓㅖㅗㅚㅜㅟㅢ',
        "Hangul.shift('ㄱㄴㄷㄹㅁㅂㅅㅇㅈㅊㅋㅌㅍㅎ ㅏㅐㅓㅔㅗㅚㅜㅟㅢ') == 'ㄲㄴㄸㄻㅃㅆㅇㅉㅊㅋㅌㅍㅎ ㅏㅒㅓㅖㅗㅚㅜㅟㅢ' - 자음, 단모음"
    );
    
    assert.deepEqual(
        Hangul.shift('ㄲㄸㅃㅆㅉㄳㄵㄼㄽㄾㅄㄶㅀㄺㄻㄿ ㅑㅒㅕㅖㅘㅙㅛㅝㅞㅠㅢ'),
        'ㄲㄸㅃㅆㅉㄲㅆㄴㅉㄹㅃㄹㅆㄾㅃㅆㄶㅀㄹㄲㄻㄿ ㅑㅒㅕㅖㅘㅗㅒㅛㅝㅜㅖㅠㅢ',
        "Hangul.shift('ㄲㄸㅃㅆㅉㄳㄵㄼㄽㄾㅄㄶㅀㄺㄻㄿ ㅑㅒㅕㅖㅘㅙㅛㅝㅞㅠㅢ') == 'ㄲㄸㅃㅆㅉㄲㅆㄴㅉㄹㅃㄹㅆㄾㅃㅆㄶㅀㄹㄲㄻㄿ ㅑㅒㅕㅖㅘㅗㅒㅛㅝㅜㅖㅠㅢ' - 쌍자음, 홑받침, 겹받침, 이중모음"
    );
    
    assert.deepEqual(
        Hangul.unshift('쪠빨또와쭈쎼요 쒸프트까 뜰어까써 안빠쪄요 쪠빨또와쭈쎼요 어컈햬야하쬬 쒸프트떄문예 미치꼤어요 이런껄로 예이예쓰 맡낄쑤또 어ㅃㅆ꼬 끄렇따꼬 냬꽁껄쑤또 어ㅃㅆ꼬 쪠빨 또와쭈쎼요'),
        '제발도와주세요 쉬프트가 들어가서 안바져요 제발도와주세요 어캐해야하죠 쉬프트대문에 미치겟어요 이런걸로 에이에스 맡길수도 없고 그렇다고 내공걸수도 없고 제발 도와주세요',
        "Hangul.unshift('쪠빨또와쭈쎼요 쒸프트까 뜰어까써 안빠쪄요 쪠빨또와쭈쎼요 어컈햬야하쬬 쒸프트떄문예 미치꼤어요 이런껄로 예이예쓰 맡낄쑤또 어ㅃㅆ꼬 끄렇따꼬 냬꽁껄쑤또 어ㅃㅆ꼬 쪠빨 또와쭈쎼요')"
    );

    assert.deepEqual(
        Hangul.unshift('괆/퀡/퇣/풿/횂/뚫/훑/송/땄/쮰/뿕/읁'),
        '괆/퀡/퇣/풿/횂/둟/훑/송/닷/쥣/붉/읁',
        "Hangul.unshift('괆/퀡/퇣/풿/횂/뚫/훑/송/땄/쮰/뿕/읁') == '괆/퀡/퇣/풿/횂/둟/훑/송/닷/쥣/붉/읁'"
    );
});
